...
const I18N = {
 en: {
  ...
  k_papers: "Total Technology Papers", k_valid: "Validated Records", k_unis: "Universities", k_quality: "Data Quality",
  q_last: "last check", q_none: "no check yet", q_ok: "Clean", q_bad: "Needs review",
  ...
  m_src: "Dataset Sources", m_time: "Timeframe", m_schema: "Data Schema", m_schema_v: "13 Normalized Fields", m_update: "Last Update",
 ...
 ar: {
  ...
  k_papers: "الأبحاث التقنية", k_valid: "سجلات اجتازت التحقق", k_unis: "الجامعات", k_quality: "جودة البيانات",
  q_last: "آخر فحص", q_none: "لم يتم الفحص بعد", q_ok: "مطابقة", q_bad: "تحتاج مراجعة",
  ...
  a_h: "التحليلات والمؤشرات", a_lede: "اختر جامعة لتصفية كل الرسوم والأرقام.",
  ...
  m_src: "مصادر البيانات", m_time: "الفترة", m_schema: "مخطط البيانات", m_schema_v: "13 حقلًا موحّدًا", m_update: "آخر تحديث",
